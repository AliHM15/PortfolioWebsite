...
function Education() {
  ...
  const educationData = [
    ...
    },
    {
      ...
      startDate: "2018",
      endDate: "2020",
      courses: "Maths, Physics Chemistry, Urdu",
    },
    {
      ...
      endDate: "2018",
      courses:
        "Urdu, Pakistan Studies, Islamiyat, Maths, English, Computer Science, Additional Maths, Environmental Management, Sociology, Chemistry, Physics",
    },
  ];
